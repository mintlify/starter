...
In sandbox, you can test the `HOURLY` frequency (not available in production). The `payroll_period_months` setting affects how much historical payroll data is generated when creating accounts.
