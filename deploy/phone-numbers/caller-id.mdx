...
To set a custom Caller ID for your outbound calls, first head to the [Caller ID](https://app.thoughtly.com/phone-number/caller-id) section of the Thoughtly dashboard. Once there, you can click "Add Caller ID" to add a new number.
