...
````mdx:premsql/introduction.mdx
  ...
  <Card title="Note" icon="pencil">
    ...
    <Step>
    You're all set! You can now perform various analyses as demonstrated in this video:
    <iframe 
      width="750" 
      height="550" 
      src="https://www.youtube.com/embed/kRwM1-y7Cvk?si=kf1H39h-Exs0CoGo&amp;start=70" 
      title="YouTube video player" 
      frameborder="0" 
