...
The prompt should be contain the tabel schemas and also all the required 
...
- **type**: str
    ...
    experiment folder. So suppose your name is expeiment is: "test_generators" then it will create a folder 
...
<img src="images/premsql/execution_guided_decoding.png" alt="Execution Guided Decoding" />
