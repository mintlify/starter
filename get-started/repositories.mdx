...
<CardGroup cols={2}>
  <Card title="Quick Start: Manual Document Upload" icon="file">
    Get started with **Prem** by uploading your documents manually.
  </Card>
  <Card title="Connect a Repository to AWS S3" icon="bucket">
    Connect your repository to AWS S3 to store and retrieve documents.
  </Card>
  <Card title="Connect a Repository to Cloudflare R2" icon="cloud">
    Connect your repository to Cloudflare R2 to store and retrieve documents.
  </Card>
  <Card title="Connect a Repository to your own Qdrant Vector DB" icon="database">
    Connect your repository to your own self hosted Qdrant Vector DB to store. This al
  </Card>
</CardGroup>
