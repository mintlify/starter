...
- Create a collection of documents that you want you'd like your LLM to interact with


{/*- Basic understanding of the Prem's APIs and SDKs*/}
...
{/*GIF of navigating on sidebar*/}
    ...
    - Upload your documents to a repository using **Prem's** interface, [API](/api-reference/introduction) or [SDK](/get-started/sdk). You can either upload documents individually or in batches. Provide meaningful names or identifiers for your documents to easily retrieve them later.
<CodeGroup>
...
{/*Gif of uploading a document*/}
  ...
  Once you've uploaded your documents you need to configure the retrieval settings. Head over to the **Lab** and choose a suitable model to test with your documents.
   ...
   You can find the following retrieval settings in the **Lab** or the **Launchpad**:
...
Before deploying your configured model, it's crucial to thoroughly test and evaluate its performance in the **Lab**.
 ...
 - **Iterative Refinement:** Based on the evaluation results, iteratively refine your assistant by adjusting the retrieval settings, fine-tuning the generative model, or improving the document collection.
  ...
  Once you're satisfied with the performance of your models, you can deploy it with the [Launchpad](/get-started/launchpad) and integrate your application with the Prem [SDKs](/get-started/sdk) or [API](/api-reference/introduction).
  </Step>
