...
{/*GIF of navigating on sidebar*/}
    ...
    - Upload your documents to a repository using Prem's interface, API or SDK. You can either upload documents individually or in batches. Provide meaningful names or identifiers for your documents to easily retrieve them later.
