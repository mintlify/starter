...
You can find more technical details in the [Technical Report](/query/technical-report) page and on [turing-bench GitHub repo](https://github.com/turing-db/turing-bench/tree/main). Especially you can find daily run information [here](https://github.com/turing-db/turing-bench/tree/bench-results/results).
