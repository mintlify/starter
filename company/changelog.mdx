...
<Update label="December 2024">
	...
	We've already made some exciting updates to Thoughtly this December. Here's a quick overview of what's new so far:
	...
	- **Multi-Region Services**: Thoughtly's services are now intercontinental 🚀
		- In addition to our main data center in **Virginia,** we now have data centers in **Oregon,** **Belgium,** and **Taiwan** to support our growing global customer base. The web platform will automatically route you to the nearest data center and should provide a much faster experience for users outside of the US.
