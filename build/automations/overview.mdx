...
To create a new Automation, navigate to the [Automations](https://app.thoughtly.com/automation) section of the Thoughtly platform via the sidebar on the left side of every page. From there, you can create a new Automation, or view and edit existing Automations.
