...
Start by heading to the [Agents](https://app.thoughtly.com/agents) page in the Thoughtly dashboard. This is where you'll find all of your Voice Agents, and where you can create new ones. Click the **Create** button to get started.
