...
<Card title="Agent Configuration" icon="gear" href="/build/agent-builder/configuration" horizontal="true">
	Ready to start configure your first Voice Agent? Continue ->
</Card>
