...
By default, Thoughtly provides a number of pre-selected Voices for you to choose from. These Voices are available in nearly [all languages that Thoughtly supports](/resources/faq#what-languages-does-thoughtly-support). These voices can be used with your Voice Agent to provide a unique sound and style.

To use custom voices from third-party platforms, you can browse the [Voice Library](/platform/voices) and save the voices you like. These voices will then be available in the Voice Selector in the Agent Builder.
...
<Frame caption="Custom Prompts">
    <iframe
        width="560"
        height="315"
        src="https://www.loom.com/embed/6757abbab8d6408f9d4ee8daa627b834?sid=66d63713-44a3-414c-8aab-99365057d033"
