...
To enable Genius, you'll first need to [create a Genius instance](/build/genius) and then select it from the dropdown in the Agent Settings. Be sure to check out the [Genius documentation](/build/genius) for more information on how to use this powerful tool.
