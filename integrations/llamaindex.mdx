---
title: "LlamaIndex"
description: "This example goes over how to use LlamaIndex to interact with ChatPrem models."
---
...
1. Sign in to PremAI, if you are coming for the first time and create your API key here.

2. Go to app.premai.io and this will take you to the project's dashboard.
