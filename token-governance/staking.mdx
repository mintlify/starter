---
title: Staking
description: Learn how to stake TRUF tokens to become a TN node operator and earn rewards.
---

For a TRUF.NETWORK node operator to go live and be able to earn fees on the data they facilitate and/or provide, their address must be whitelisted in the Truflation Protocol. A TN address can be whitelisted only after they have staked TRUF tokens.
