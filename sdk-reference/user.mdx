...
Friending creates mutual connections. Use this method to create a friend request, or ff someone has already sent you a friend request, this will create the mutual friendship:
