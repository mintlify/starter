...
<Note>
The best part is, you do not have to write this positive or negative rules. Prem's system will do it for you.
...
As you can see, all we have to write is a very good description of what we want to evaluate.
