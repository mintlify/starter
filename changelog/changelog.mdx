...
- **State Synchronization:** Enabled StateSync on TN servers and introduced snapshot options for new node synchronization.
...
- **Build Enhancements:** Utilized TN-operator genesis files and adjusted release packages naming conventions.
- **Continuous Integration:** Released TN binaries via GitHub releases and implemented deployment stacks with predefined configurations.
...
- **System Contract Fixes:** Addressed timeouts and ensured correct external addresses for TN nodes.
...
- **Deployment Enhancements:** Improved resilience of TN-DB Docker services and addressed consensus errors.
...
- **Metrics Integration:** Enabled local viewing of TN metrics.
- **Bug Fixes:** Corrected output values and ensured graceful deployment failure handling.
- **Documentation Updates:** Provided examples for using the indexer to obtain TN metrics.
...
- **Terminology Updates:** Established common terminology and applied it across the TN project.
