...
<Steps>
  ...
  <Step title="Add a Name, Choose a Dataset and a Model Type">
    ...
    ![GIF of adding a name, choosing a dataset and a model type](https://static.premai.io/prem-saas-docs/fine-tuning/get-started/step-2-add-name-choose-dataset-and-model-type.gif)
