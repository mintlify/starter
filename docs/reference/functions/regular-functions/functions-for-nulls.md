...
{/* <!--AUTOGENERATED_START--> */}
## assumeNotNull <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## coalesce <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## firstNonDefault <Badge intent="info" className="version-badge">v25.9+</Badge> 
...
## ifNull <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## isNotNull <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## isNull <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## isNullable <Badge intent="info" className="version-badge">v22.7+</Badge> 
...
## isZeroOrNull <Badge intent="info" className="version-badge">v20.3+</Badge> 
...
## nullIf <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## toNullable <Badge intent="info" className="version-badge">v1.1+</Badge> 
