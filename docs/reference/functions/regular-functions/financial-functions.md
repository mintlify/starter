...
{/* <!--AUTOGENERATED_START--> */}
## financialInternalRateOfReturn <Badge intent="info" className="version-badge">v25.7+</Badge> 
...
## financialInternalRateOfReturnExtended <Badge intent="info" className="version-badge">v25.7+</Badge> 
...
## financialNetPresentValue <Badge intent="info" className="version-badge">v25.7+</Badge> 
...
## financialNetPresentValueExtended <Badge intent="info" className="version-badge">v25.7+</Badge> 
