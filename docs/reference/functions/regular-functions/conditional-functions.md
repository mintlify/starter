...
{/* <!--AUTOGENERATED_START--> */}
## clamp <Badge intent="info" className="version-badge">v24.5+</Badge> 
...
## greatest <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## if <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## least <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## multiIf <Badge intent="info" className="version-badge">v1.1+</Badge> 
