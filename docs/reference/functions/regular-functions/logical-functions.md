...
{/* <!--AUTOGENERATED_START--> */}
## and <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## not <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## or <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## xor <Badge intent="info" className="version-badge">v1.1+</Badge> 
