...
{/* <!--AUTOGENERATED_START--> */}
## bitAnd <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitCount <Badge intent="info" className="version-badge">v20.3+</Badge> 
...
## bitHammingDistance <Badge intent="info" className="version-badge">v21.1+</Badge> 
...
## bitNot <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitOr <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitRotateLeft <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitRotateRight <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitShiftLeft <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitShiftRight <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitSlice <Badge intent="info" className="version-badge">v22.2+</Badge> 
...
## bitTest <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitTestAll <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitTestAny <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## bitXor <Badge intent="info" className="version-badge">v1.1+</Badge> 
