...
{/* <!--AUTOGENERATED_START--> */}
## ceil <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## floor <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## round <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## roundAge <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## roundBankers <Badge intent="info" className="version-badge">v20.1+</Badge> 
...
## roundDown <Badge intent="info" className="version-badge">v20.1+</Badge> 
...
## roundDuration <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## roundToExp2 <Badge intent="info" className="version-badge">v1.1+</Badge> 
...
## trunc <Badge intent="info" className="version-badge">v1.1+</Badge> 
