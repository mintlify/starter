...
sidebarTitle: 'Querying JSON from S3 with chDB'
...
<Badge size="lg" color="orange">Chdb</Badge>
</div>
{/* AUTOGENERATED_END */}

## Prerequisites

To successfully follow this quick start guide, you'll need the following:
- Python v3+
...
<Step title="Querying a JSON file in S3">
...
<Step title="Configuring the output format">
...
<Step title="Creating a table from JSON file">
...
<Step title="Querying a Pandas dataframe">
