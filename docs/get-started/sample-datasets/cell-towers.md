...
<img src="/images/getting-started/example-datasets/superset-cell-tower-dashboard.png" alt="Dashboard of cell towers by radio type in mcc 204"/>
...
<img src="/images/_snippets/cloud-load-data-sample.png" alt="Load cell towers dataset"/>
...
<GatherYourDetailsHttp />
  ...
  <img src="/images/getting-started/example-datasets/superset-add.png" alt="Add a database"/>
  
  Choose **ClickHouse Connect** from the list:

  <img src="/images/getting-started/example-datasets/superset-choose-a-database.png" alt="Choose clickhouse connect as database type"/>
...
<Tip>
  ...
  <img src="/images/getting-started/example-datasets/superset-connect-a-database.png" alt="Add ClickHouse as a Superset data source"/>
...
<img src="/images/getting-started/example-datasets/superset-add-dataset.png" alt="Add cell_towers table as a dataset"/>
...
<img src="/images/getting-started/example-datasets/superset-create-map.png" alt="Create a map in Superset"/>
...
<img src="/images/getting-started/example-datasets/superset-lon-lat.png" alt="Specify longitude and latitude fields"/>

Add a filter with `mcc` = `204` (or substitute any other `mcc` value):

<img src="/images/getting-started/example-datasets/superset-mcc-204.png" alt="Filter on MCC 204"/>
...
<img src="/images/getting-started/example-datasets/superset-radio-umts.png" alt="Filter on radio equal to UMTS"/>

This is the full configuration for the chart that filters on `radio = 'UMTS'` and `mcc = 204`:

<img src="/images/getting-started/example-datasets/superset-umts-netherlands.png" alt="Chart for UMTS radios in MCC 204"/>
