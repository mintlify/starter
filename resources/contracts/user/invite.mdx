---
title: "User > Invite"
description: "Manages creation, validation, and tracking of user invitations. @sage/user > invite"
---
...
### Function `assert_invite_not_required`
...
### Function `assert_invite_is_valid`
...
### Function `get_destructured_invite`
