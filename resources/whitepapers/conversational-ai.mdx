...
<Warning>By using a product that utilizes generative language models, you acknowledge a minimal risk of occasional unexpected outputs. With Thoughtly, however, this risk is minimized through product guardrails and is likely lower than what may occur with human agents.</Warning>
...
<Steps>
	...
	<Step title="Edge Case Discovery">
