...
To get started, you'll need to create an API key in the [Thoughtly dashboard](https://app.thought.ly). This key will be used to authenticate your requests to the API.
