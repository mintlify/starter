...
MySQL is the primary database, used for example for storing user, projects, saved datasets and settings. Since this is not where
most of the heavy work is, any MySQL or MySQL-compatible database like AWS RDS should work.
