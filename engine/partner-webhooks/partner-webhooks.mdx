...
description: "Subscribe to partner API events."
---

Partner webhooks notify your integration when important partner API events happen.
...
They are not scoped to a single company or incorporation. A subscription receives events for partner-accessible resources when its `eventTypes` includes the emitted event.
