...
They are not scoped to a single customer or incorporation. A subscription receives events for partner-accessible resources when its `eventTypes` includes the emitted event.
