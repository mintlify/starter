...
<Columns cols={2}>
  <Card title="Customer container setup" icon="building" href="/engine/incorporation/company-POST">
    Create the customer/company container that scopes later partner incorporation and Commenda OS calls.
  </Card>
...
<Columns cols={2}>
  <Card title="Understand incorporation concepts" icon="map" href="/engine/incorporation/partner-incorporation-core-concepts">
    Review the object model, ID handoffs, and Commenda OS dependency before implementation.
  </Card>
