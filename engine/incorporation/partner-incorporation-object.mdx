...
| `companyId` | integer | Customer/company container that owns the incorporation. This is not the legal entity being incorporated. |
...
| `corporationId` | integer or null | Target Commenda OS business entity id for the company being incorporated. Corporate shareholder business entity ids are separate participant resource ids. |
