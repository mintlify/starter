...
openapi: "POST /partner/incorporation/customers/{customerId}/incorporations"
---
...
- `customerId` is the path parameter for the Commenda company that owns the incorporation.
