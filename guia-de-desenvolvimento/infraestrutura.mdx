...
Para uma visão mais detalhada e técnica sobre o funcionamento do **Data Lake da IplanRio** e como ele se integra com o **Data Lake das demais Secretarias**, acessar:

[Documentação Técnica](https://docs.dados.rio/guia-desenvolvedores/visao-geral-infra/)