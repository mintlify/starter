---
title: "Convenções para Nomeação e Ordenamento de Colunas de Tabelas"
...
- `valor_total_pago_valor`: valor total pago
- `ativo_indicador`: flag de ativo
- `paciente_tipo_logradouro_sigla`: sigla do tipo de logradouro do paciente
