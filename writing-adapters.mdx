...
The repository offers several reusable tasks to facilitate data ingestion into TN:
...
- **TN Operations**:
- `task_insert_tsn_records`: Inserts records into TN.
- `task_get_all_tsn_records`: Fetches all records from TN.
...
- `task_prepare_records_for_tsn`: Prepares records for insertion into TN.
