...
In this example, we're going to build a Voice Agent that collects information from the caller before transferring the call to a human agent. For this scenario, we'll be using [Zendesk](/integrations/crm/zendesk) to create a ticket and transfer the call to the appropriate department.
