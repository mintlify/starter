...
<Info>
  Further details on \$TRUST token economics, minting phases, and specific action weighting models are provided in [Architecture \> \$TRUST Economics](/architecture/7-trust-economics).
</Info>