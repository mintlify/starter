...
<Tip>
  For more details on \$TRUST token economics see the [\$TRUST Mechanics](/architecture/7-trust-mechanics) section.
</Tip>

### Sybil Resistance & Anti-Gaming

Tying reward issuance to validated actions and measurable transaction fees inherently discourages spam, manipulation, and low-quality activity. Beyond this natural safeguard, Sage builds in additional defenses that ensure authentic user engagement remains the primary path to earning \$TRUST. Key anti-gaming defenses include:
