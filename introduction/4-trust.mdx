...
**\$TRUST** is crypto's first [Earned Mint Token (EMT)](/introduction/3-emt) and powers Sage Protocol's economy. Unlike traditional tokens, \$TRUST is minted exclusively through verified social actions using [Proof of Social Contribution (PoSC)](/introduction/2-posc). This creates a self-regulating economy, naturally balancing supply and demand to encourage high-quality content, support long-term economic sustainability, and motivate active user participation.
