...
**\$TRUST** is crypto's first [Earned Mint Token (EMT)](/introduction/3-emt) and powers Sage Protocol's economy. Unlike traditional tokens, \$TRUST is minted exclusively through verified social actions using [Proof of Social Contribution (PoSC)](/introduction/2-posc). This creates a self-regulating economy, naturally balancing supply and demand to encourage high-quality content, support long-term economic sustainability, and motivate active and timely user participation.
...
Below is the current list of eligible actions and their beta-phase weights:
...
Alongside the currently implemented actions, we've identified additional actions we'll add as Sage evolves. These new actions will help us better capture nuanced forms of user engagement, making our incentive system even more responsive and comprehensive. Initially, Sage's core team will define these actions and their weights, but as we move toward full decentralization, this responsibility will shift to community governance. Ultimately, our community will decide which actions earn rewards and how they're valued, keeping incentives closely aligned with shared goals.
