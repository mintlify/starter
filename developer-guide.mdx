...
2. Follow the instructions in the [README.md](https://github.com/trufnetwork/node/blob/main/deployments/dev-gateway/README.md) file to set up and run the gateway.
...
For further assistance, join our [Discord community](https://discord.com/invite/5AMCBYxfW4) or open an issue on our [GitHub repository](https://github.com/trufnetwork/node/issues).
