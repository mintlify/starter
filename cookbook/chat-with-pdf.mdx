...
Welcome to Prem AI cookbook section. In this first example, we will ste by step build a simple chat with pdf application (~ 100 lines of code) using [prem ai sdk](/get-started/sdk.mdx) and [streamlit](https://streamlit.io/). The best part, you don't even need to understand complex mechanisms like RAG or Retrieval Augmented Generations to make this app. So without further adue, let's get started. You can find the full code [here](https://github.com/premAI-io/cookbook/chat-with-pdf).
...
We add some more styling in the [final code](https://github.com/premAI-io/cookbook/chat-with-pdf). base and this is how it would look like. 

<img
  src="/images/cookbook/chat_with_pdf_app.png"
  alt="Playground"
/>