...
<Accordion title="Explore Admin Package Modules">
  <Card title="Access Module" href="resources/contracts/admin/access.mdx">
    Provides strict type-based access controls, ensuring only correctly authorized entities perform sensitive operations. It defines and verifies configurations for various object and witness types, enforcing robust security through explicit assertions.
  </Card>
</Accordion>
